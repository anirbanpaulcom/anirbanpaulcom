...
const typeClassname = {
  ...
  p1: 'font-base text-lg sm:text-lg md:text-lg lg:text-xl my-1 text-gray break-words',
  ...
  p2: 'font-light text-sm sm:text-sm md:text-base lg:text-base my-1 text-gray break-words',
